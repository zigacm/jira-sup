"""Plain async Jira tool functions, decoupled from MCP.

The FastMCP server (`server.py`) imports this module to keep tool behaviour
centralized and testable.

Docstrings here are LLM-facing — keep them precise.
"""
...
# Registry used by both MCP server and bot's tool dispatcher.
ALL_TOOLS = {
    "get_current_user": get_current_user,
    "list_projects": list_projects,
    "search_users": search_users,
    "list_transitions": list_transitions,
    "list_issue_link_types": list_issue_link_types,
